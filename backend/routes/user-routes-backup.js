...
const supabaseUserServicePath = require.resolve('../services/supabaseUserService');
if (require.cache[userServicePath]) {
    console.log('🔄 [ROUTES] Очищаємо кеш старого userService');
...
// Перевіряємо що використовується правильний сервіс
console.log('✅ [ROUTES] UserService class:', userService.constructor.name);
console.log('✅ [ROUTES] Is SupabaseUserService:', userService instanceof SupabaseUserService);
...
router.get('/', requireAdmin, async (req, res, next) => {
    try {
        console.log('🔍 [DEBUG] GET /api/users - start');
        console.log('🔍 [DEBUG] userService type:', typeof userService);
        console.log('🔍 [DEBUG] userService constructor:', userService.constructor.name);
...
router.post('/', requireAdmin, async (req, res, next) => {
    try {
        const { username, last_name, email, phone, role, permissions, password } = req.body;
...
router.put('/:id', requireAdmin, async (req, res, next) => {
    try {
        ...
        const { username, last_name, email, phone, role, permissions, active, password } = req.body;
...
// Ініціалізуємо SupabaseUserService
